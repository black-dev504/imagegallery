...
<div class="w-full p-5">
    <nav class="flex justify-between items-center py-8 border-b border-black/10">
        ...
        <div class="flex items-center space-x-4">
            ...
            @guest
                <a href="/login" class="bg-blue-white text-blue-500 border-1 border-blue-500 px-4 py-2 rounded-full hover:text-white hover:bg-blue-600 transition">
                    Log In
                </a>

                <a href="/signup" class="bg-blue-500 text-white px-4 py-2 rounded-full hover:bg-white hover:text-blue-500 hover:border-1 border-blue-500 transition">
                    Sign Up
                </a>
            @endguest
